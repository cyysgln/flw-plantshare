package com.flower.component.actionLog.annotation;

import com.flower.component.actionLog.action.base.BaseActionMap;
import com.flower.component.actionLog.action.base.ResetLog;
import com.flower.component.actionLog.action.model.ActionModel;
import com.flower.component.actionLog.action.model.BusinessMethod;
import com.flower.common.utils.SpringContextUtil;
import com.flower.component.actionLog.action.model.BusinessType;
import com.flower.component.shiro.ShiroUtil;
import com.flower.modules.system.domain.ActionLog;
import com.flower.modules.system.service.ActionLogService;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.flower.component.actionLog.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.flower.component.actionLog.annotation.ActionLog anno =
                targetMethod.getAnnotation(com.flower.component.actionLog.annotation.ActionLog.class);
        // 获取name值
